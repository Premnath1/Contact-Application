...
import in.prem.capp.command.LoginCommand;
import in.prem.capp.command.UserCommand;
import in.prem.capp.domain.User;
import in.prem.capp.exception.UserBlockedException;
import in.prem.capp.service.UserService;
...
public class UserController {
    ...
    // Method will be called when url matches with this path.
    @RequestMapping(value = {"/", "/index"})        //Multiple url
    public String index(Model m) {
        m.addAttribute("command", new LoginCommand());
        return "index"; //JSP - /WEB-INF/view/index.jsp
    }

    //In Case of GET Method credentials will be visible in url
